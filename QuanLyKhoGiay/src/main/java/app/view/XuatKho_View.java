...
import app.controller.XuatKho_Controller;
...
public class XuatKho_View extends JPanel {
    private Kho_Controller controllerKho;
    private XuatKho_Controller xuatController;
    ...
    public XuatKho_View() {
        ...
        JLabel title = new JLabel("PHIẾU XUẤT KHO", JLabel.CENTER);
        ...
        infoPanel.add(new JLabel("Kho xuất:"));
        ...
        selectPanel.setBorder(BorderFactory.createTitledBorder("Chọn sản phẩm xuất"));
        selectPanel.setBackground(Color.WHITE);
        btnAdd = new JButton("Thêm sản phẩm");
        btnSave = new JButton("Lưu");
        btnRemove = new JButton("Xóa");
        modelSanPham = new DefaultComboBoxModel();
        xuatController = new XuatKho_Controller(this);
        xuatController.getAllSanPham(modelSanPham);
        ...
        scrollPane.setBorder(BorderFactory.createTitledBorder("Danh sách sản phẩm xuất kho"));
    ...
    public Kho_Controller getControllerKho() {return controllerKho;}
    public XuatKho_Controller getXuatController() {return xuatController;}
